...
public class NotificationEndpoint : Endpoint<PostNotificationRequest, EmptyResponse>
{
    ...
    public override async Task<EmptyResponse> ExecuteAsync(PostNotificationRequest req, CancellationToken ct)
    {
        ...
        {
            await _notificationService.Clear(new NotificationId(req.Id));
        }
        return Response;
    }
}
